...
class ilen_video_lock extends ilen_video_lock_make{
    ...
    function script_and_style_front(){
        ...
        wp_enqueue_script('facebook-js', 'https://connect.facebook.net/en_US/sdk.js#version=v2.3&xfbml=1&appId=', array('jquery'),$this->parameter['version'],FALSE);
    ...
    function show_ilenvideolock( $atts, $content = null ){
        ...
        global $if_utils,$post, $option_ilenvideolock;
        ...
        if( isset($option_ilenvideolock->video_thumbnail) && $option_ilenvideolock->video_thumbnail  ){
            ...
            $image_share = $if_utils->IF_get_image( "medium", null, $post->ID  );
            $id_video    = $content;
        ...
        $video_id_hash = hash( 'sha256', $id_video );
